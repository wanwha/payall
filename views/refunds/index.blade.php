            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="hidden-480">{{ HTML::link('refunds/'.$refund->mb_refund_id, GetList::$list_prefix[$refund->mb_mem_prefix].$refund->mb_mem_fnameth.' '.$refund->mb_mem_lnameth ) }}</td>
                        <td class="center hidden-480">{{ GetFormat::format_DateTime($refund->mb_refund_credate) }}</td>
                        <td class="center">{{ GetFormat::format_DateTime($refund->mb_refund_issuedate) }}</td>
                        <td class="center">{{ GetList::$list_status[$refund->mb_refund_status] }}</td>
                        <td class="center">
