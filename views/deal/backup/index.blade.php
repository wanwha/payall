...
@section('breadcrumbs')
<ul class="breadcrumb">
    <li><a href="{{ URL::to('deal') }}"><i class="fa fa-barcode fa-lg"></i>จัดการดีล/คูปอง</a></li>
    <li class="active">รายการข้อมูลดีล</li>
</ul>
@stop


@section('pageheader')
<h1>รายการข้อมูลดีล</h1>
@stop
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">{{ $deal->de_deal_title }}</td>
                        <td class="hidden-480">{{ $deal->de_deal_typeid }}</td>
                        <td class="hidden-480">{{ $deal->de_deal_cateid }}</td>
                        <td class="center">{{ $deal->de_deal_shopid }}</td>
                        <td class="center">{{ $deal->de_deal_pa }}</td>
                        <td class="center">{{ $deal->de_deal_total }}</td>
                        <td class="center">{{ $deal->de_deal_sdate.' - '.$deal->de_deal_edate  }}</td>
                        <td class="center">
                            <div class="hidden-sm hidden-xs action-buttons">   
                                ...
                                <a href='javascript:void(0)' class="red bootbox-confirm" onclick="
                                    ...
                                    document.getElementById('hidden_rowcode').value='{{ $deal->de_deal_title }}';
