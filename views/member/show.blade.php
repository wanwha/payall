    ...
    <div class="col-xs-12">
        ...
        <div class="row" style="padding-bottom:20px;">
            <span class="btn btn-app btn-sm btn-success pull-right" style="width: initial; margin-left:7px; margin-right:10px; padding-left: 20px; padding-right: 20px; cursor: default;">
                    ...
                    <span class="line-height-1 bigger-170"> {{ number_format($mem->mb_mem_pacash, 2) }} </span>
            </span>
            <span class="btn btn-app btn-sm btn-grey pull-right" style="width: initial; margin-left:7px; padding-left: 20px; padding-right: 20px; cursor: default;">
                    ...
                    <span class="line-height-1 bigger-170"> {{ number_format($mem->mb_mem_pacredit, 2) }} </span>
            </span>
            <span class="btn btn-app btn-sm btn-yellow pull-right" style="width: initial; margin-left:7px; padding-left: 20px; padding-right: 20px; cursor: default;">
                    ...
                    <span class="line-height-1 bigger-170"> {{ number_format($mem->mb_mem_point) }} </span>
            </span>
        </div>
                ...
                <div id="tab_profile" class="tab-pane fade in active">
                    ...
                    <div class="profile-user-info profile-user-info-striped" style="margin-top:10px;">
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ $mem->mb_mem_code }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> สัญชาติ : </div>
                                <div class="profile-info-value">{{ GetList::$list_nation[$mem->mb_mem_nationalityid] }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> หมายเลขประชาชน : </div>
                                <div class="profile-info-value">{{ $mem->mb_mem_citid }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> คำนำหน้า : </div>
                                <div class="profile-info-value">{{ GetText::expld_text($list_prefix[$mem->mb_mem_prefix], 'TH') }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                        ...
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ $mem->mb_mem_fnameen }}</div>
                                <div class="profile-info-name"> สกุล (ภาษาอังกฤษ) : </div>
                                <div class="profile-info-value">{{ $mem->mb_mem_lnameen }}</div>  
                        </div>
                        <div class="profile-info-row">
                        ...
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ $mem->mb_mem_password }}&nbsp;&nbsp;&nbsp;{{ Form::checkbox('agree', null, true, array('class'=>'ace input-lg')) }}<span class="lbl bigger-120"></span></div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> เบอร์โทรศัพท์ : </div>
                                <div class="profile-info-value">{{ $mem->mb_mem_phone }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> เพศ : </div>
                                <div class="profile-info-value">{{ GetText::expld_text($list_gender[$mem->mb_mem_gender], 'TH') }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> ว/ด/ป เกิด : </div>
                                <div class="profile-info-value">{{ GetFormat::format_DateTime($mem->mb_mem_dateofbirth) }} อายุ : xxปี </div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> วันที่เปิดสมาชิก : </div>
                                <div class="profile-info-value">{{ GetFormat::format_DateTime($mem->mb_mem_sdate) }} ถึง {{ GetFormat::format_DateTime($mem->mb_mem_edate) }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> ตำแหน่ง : </div>
                                <div class="profile-info-value">{{ $mem->mb_mem_posid }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> สถานะ : </div>
                                <div class="profile-info-value">{{ GetList::$list_type[$mem->mb_mem_type]}}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> รหัสอุปกรณ์ : </div>
                                <div class="profile-info-value">{{ $mem->mb_mem_device }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                    </div>    
                ...
                <div id="tab_addr" class="tab-pane fade">
                    <div class="profile-user-info profile-user-info-striped" style="margin-top:10px;">
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ GetList::$list_locate[$mem->mb_mem_locateid] }}</div>
                        </div>
                        <div class="profile-info-row">
                        ...
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ $list_subprovince[$mem->mb_mem_subprovid] }}</div>
                        </div>
                        <div class="profile-info-row">
                        ...
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ $mem->mb_mem_tel }}</div>
                        </div>
                        <div class="profile-info-row">
...
<div class="profile-user-info profile-user-info-striped" style="margin-top:10px;">
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ GetText::expld_text($list_bank[$mem->mb_mem_bankid], 'TH') }}</div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> ชื่อบัญชี : </div>
                                <div class="profile-info-value">{{ $mem->mb_mem_accname }}</div>
                        </div>
                        <div class="profile-info-row">
                                <div class="profile-info-name"> เลขบัญชี : </div>
                                <div class="profile-info-value">{{ $mem->mb_mem_accno }}</div>
                        </div>
                    </div>    
                </div>
        ...
        <div class="row">
            <div class="col-xs-12 center">
                {{ HTML::link('member','ย้อนกลับ',array('class'=>'btn btn-warning btn-lg','style'=>'margin:20px;')) }}
            </div>
        </div>    
