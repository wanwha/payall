...
<ul class="breadcrumb">
    ...
    <li class="active">แก้ไขร้านค้า</li>
</ul>
@stop
...
<div class="row">
    <div class="col-xs-12">
        ...
        {{ Form::model($shop,array('route'=>array('shop.update',$shop->sh_shop_id),'method'=>'PUT','class'=>'form-horizontal')) }}
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                 {{ Form::label('sh_shop_typeid', 'ประเภทร้านค้า :', array('class' => 'col-sm-2 control-label')) }}
                     ...
                     <div class="col-sm-2">
                        {{ Form::checkbox('sh_shop_typeid[]','ID1',null,array('class'=>'ace')) }}
                            <span class="lbl bigger-120"> ดีล/คูปอง</span>
                      </div>
                      <div class="col-sm-2">
                        {{ Form::checkbox('sh_shop_typeid[]','ID2',null,array('class'=>'ace','style'=>'margin-left:7px')) }}
                            <span class="lbl bigger-120"> เพลแครช</span>
                      </div>        
                      <div class="col-sm-2">
                        {{ Form::checkbox('sh_shop_typeid[]','ID3',null,array('class'=>'ace','style'=>'margin-left:7px' )) }}
            ...
            <div class="form-group">
                 ...
                 <div class="col-sm-8">
                 {{ Form::select('input_cateid', $list_cate ,$shop->sh_shop_cateid, array('class'=>'form-control','id'=>'input_cateid')) }}
                 </div>
                 <span  style="color:#dd5a43;" ><b>*</b></span>
            </div>
