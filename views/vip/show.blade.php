                ...
                <div id="tab_profile" class="tab-pane fade in active">
                    ...
                    <div class="profile-user-info profile-user-info-striped" style="margin-top:10px;">
                        ...
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ GetList::$list_nation[$vip->mb_mem_nationalityid] }}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                        ...
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ GetList::$list_type[$vip->mb_mem_type]}}</div>
                                <div class="profile-info-value hidden-480"></div>
                                <div class="profile-info-value hidden-480"></div>
                        </div>
                        <div class="profile-info-row">
                ...
                <div id="tab_addr" class="tab-pane fade">
                    <div class="profile-user-info profile-user-info-striped" style="margin-top:10px;">
                        <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">{{ GetList::$list_locate[$vip->mb_mem_locateid] }}</div>
                        </div>
                        <div class="profile-info-row">
