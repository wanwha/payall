...
<ul class="breadcrumb">
    ...
    <li class="active">รายการหมวดหมู่ย่อย</li>
</ul>
@stop


@section('pageheader')
<h1>รายการหมวดหมู่ย่อย</h1>
@stop
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-header">
            ...
            {{ Form::open( array( 'url'=>'subcate/delall', 'id'=>'form-del-delall') ) }}   
        ...
        <div class="clearfix">
            <a class="btn btn-sm btn-primary" href="{{ URL::to('subcate/create') }}">สร้างใหม่</a>
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center hidden-480">{{ EditFormat::format_DateTime ($value->de_set_scate_updatedate) }}</td>
                        <td class="center">
                        ...
                        <a class="green" href="{{ URL::to('subcate/'.$value->de_set_scate_id.'/edit') }}">
                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                        </a>

                        <a href='javascript:void(0)' class="red bootbox-confirm" onclick="
                            document.getElementById('hidden_rowid').value='{{ $value->de_set_scate_id }}';
                            document.getElementById('hidden_rowcode').value='{{ $value->de_set_scate_nameth }}';
                            "><i class="ace-icon fa fa-trash-o bigger-120"></i></a>
                            {{ Form::open( array( 'url'=>'subcate/'.$value->de_set_scate_id, 'id'=>'form-del-'.$value->de_set_scate_id ) )}}
                            {{ Form::hidden( '_method','DELETE' ) }}
                            {{ Form::close() }}
                    </div>
                    <div class="hidden-md hidden-lg">
                        <div class="inline pos-rel">
                            ...
                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                ...
                                <li>
                                    <a href="{{ URL::to('subcate/'.$value->de_set_scate_id.'/edit') }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                        <span class="green">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $(".bootbox-confirm").on(ace.click_event, function () {
            ...
            bootbox.confirm({
                message: "ต้องการลบหมวดหมู่ย่อย "+row_code+" ถูกต้องใช่หรือไม่?",
                buttons: {
                    confirm: {
                        label: "ลบ",
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $(".bootbox-confirm-delall").on(ace.click_event, function () {
            ...
            bootbox.confirm({
                message: "ต้องการลบข้อมูลหมวดหมู่ย่อยที่เลือกทั้งหมด ใช่หรือไม่?",
                buttons: {
                    confirm: {
                        label: "ลบ",
                        className: "btn-danger btn-sm",
