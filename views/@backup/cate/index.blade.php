...
<ul class="breadcrumb">
    ...
    <li class="active">รายการหมวดหมู่</li>
</ul>
@stop
...
{{ Form::hidden('hidden_rownameth', null, array('id'=>'hidden_rownameth')) }}
{{ Form::close() }}


{{ Form::open( array( 'url'=>'cate/delall', 'id'=>'form-del-delall') ) }}   
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="clearfix">
            <a class="btn btn-sm btn-primary"  href="{{ route('cate.create') }}">สร้างใหม่</a>
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center hidden-480">{{ EditFormat::format_DateTime($cate->de_set_cate_updatedate) }}</td>
                            ...
                            <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                    ...
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                        ...
                                        <li>{{ HTML::decode(link_to('cate/'.$cate->de_set_cate_id.'/edit', '<span class="green"><i class="ace-icon fa fa-pencil-square-o bigger-120"></i></span>', array('class'=>'tooltip-success','data-rel'=>'tooltip','title'=>'Edit'))) }}</li>                  
                                        <li>
                                           <a href='javascript:void(0)' class="red bootbox-confirm tooltip-error" data-rel="tooltip" title="Delete" 
                                              onclick="document.getElementById('hidden_rowid').value='{{ $cate->de_set_cate_id }}';
                                                  document.getElementById('hidden_rownameth').value='{{ $cate->de_set_cate_nameth }}';">
...
jQuery(function ($) {
        ...
        $(".bootbox-confirm").on(ace.click_event, function () {
            ...
            row_nameth = $('#hidden_rownameth').val();
            bootbox.confirm({
                message: "ต้องการลบหมวดหมู่ "+row_nameth+" ถูกต้องใช่หรือไม่?",
                buttons: {
                    confirm: {
                        label: "ลบ",
   ...
   jQuery(function ($) {
        ...
        $(".bootbox-confirm-delall").on(ace.click_event, function () {
            ...
            bootbox.confirm({
                message: "ต้องการลบหมวดหมู่ที่เลือกทั้งหมด ถูกต้องใช่หรือไม่?",
                buttons: {
                    confirm: {
                        label: "ลบ",
                        className: "btn-danger btn-sm",
