...
@section('breadcrumbs')
<ul class="breadcrumb">
    <li class="active"><a href="#"><i class="fa fa-shopping-cart fa-lg"></i>ร้านค้า</a></li>
</ul>
@stop
...
<div class="row">
    <div class="col-xs-12">
        ...
        @if( Session::has('message') )
            <div class="alert alert-info">{{ Session::get('message') }}</div><br /><br />
        @endif
        </div>

        <div class="clearfix">
            <a class="pull-left btn btn-sm btn-primary" href="{{ URL::to('refunds/create') }}">ขอคืนเงิน</a>
            <a class="pull-left btn btn-sm btn-warning" href="#" style="margin-left:10px;">ลบรายการ</a>
