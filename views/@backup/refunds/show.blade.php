    ...
    <div class="col-xs-12">
        ...
        <div class="profile-user-info profile-user-info-striped" style="margin-top:10px;">
            ...
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">{{ Mem::$list_prefix[$refund->mb_mem_prefix].$refund->mb_mem_fnameth.' '.$refund->mb_mem_lnameth }}</div>
            </div>
            <div class="profile-info-row">
                    <div class="profile-info-name"> สมัครเมื่อวันที่ : </div>
                    <div class="profile-info-value">{{ EditFormat::format_DateTime($refund->mb_refund_credate) }}</div>
            </div>
            <div class="profile-info-row">
                    <div class="profile-info-name"> ขอคืนเงินเมื่อวันที่ : </div>
                    <div class="profile-info-value">{{ EditFormat::format_DateTime($refund->mb_refund_issuedate) }}</div>
            </div>
            <div class="profile-info-row">
                    <div class="profile-info-name"> สถานะรายการ : </div>
                    <div class="profile-info-value">
                        {{ Refund::$list_status[$refund->mb_refund_status] }}&nbsp;&nbsp;
            ...
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">{{ EditFormat::format_DateTime($refund->mb_refund_appdate) }}</div>
            </div>
            <div class="profile-info-row">
                    <div class="profile-info-name"> เหตุผลการอนุมัติ : </div>
                    <div class="profile-info-value">{{ Refund::$list_remark[$refund->mb_refund_remark] }}</div>
            </div>
            @endif
