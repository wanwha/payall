...
<ul class="breadcrumb">
    ...
    <li class="active">รายละเอียดซีเรียวดีล/คูปอง</li>
</ul>
@stop


@section('pageheader')
<h1>รายละเอียดซีเรียวดีล/คูปอง</h1>
@stop
    ...
    <div class="col-xs-12">
        ...
        <div class="profile-user-info profile-user-info-striped" style="margin-top:10px;">
            ...
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">{{ $branch_nameth }}</div>
            </div>
            <div class="profile-info-row">
            ...
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">{{ $deal->de_deal_price }}</div>
            </div>
            <div class="profile-info-row">
                    <div class="profile-info-name"> ร้านค้าลด : </div>
                    <div class="profile-info-value">{{ $deal->de_deal_shopdis }}</div>
            </div>
            <div class="profile-info-row">
                    <div class="profile-info-name"> ส่วนลดลูกค้า : </div>
                    <div class="profile-info-value">{{ $deal->de_deal_cusdis }}</div>
            </div>
            <div class="profile-info-row">
                    <div class="profile-info-name"> PA : </div>
                    <div class="profile-info-value">{{ $deal->de_deal_pa }}</div>
            </div>
            <div class="profile-info-row">
                    <div class="profile-info-name"> Point ที่ได้ : </div>
        ...
        <div class="profile-user-info profile-user-info-striped" style="margin-top:35px;">
            ...
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">{{ $deal->de_deal_credate }}</div>
                    <div class="profile-info-name"> แก้ไขเมื่อ : </div>
                    <div class="profile-info-value">{{ $deal->de_deal_updatedate }}</div>
            </div>
        </div>

        <div class="row" style="margin:20px;">
            <div class="col-xs-12 center">
                {{ HTML::link('deal/'.$deal->de_deal_id.'/edit','แก้ไข',array('class'=>'btn btn-success')) }}
...
{{ HTML::script('assets/js/ace/jquery.ui.touch-punch.js') }}
{{ HTML::script('assets/js/ace/jquery.gritter.js') }}
{{ HTML::script('assets/js/ace/bootbox.js') }}
{{ HTML::script('assets/js/ace/jquery.easypiechart.js') }}
{{ HTML::script('assets/js/ace/date-time/bootstrap-datepicker.js') }}
{{ HTML::script('assets/js/ace/jquery.hotkeys.js') }}
{{ HTML::script('assets/js/ace/bootstrap-wysiwyg.js') }}
{{ HTML::script('assets/js/ace/select2.js') }}
{{ HTML::script('assets/js/ace/fuelux/fuelux.spinner.js') }}
{{ HTML::script('assets/js/ace/x-editable/bootstrap-editable.js') }}
{{ HTML::script('assets/js/ace/x-editable/ace-editable.js') }}
{{ HTML::script('assets/js/ace/jquery.maskedinput.js') }}
