...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-header">
            ...
            {{ Form::open( array( 'url'=>'businesscenter/delall', 'id'=>'form-del-delall') ) }}   
        ...
        <div class="clearfix">
            <a class="btn btn-sm btn-primary" href="{{ URL::to('businesscenter/create') }}">สร้างใหม่</a>
            <a class="btn btn-sm btn-danger bootbox-confirm-delall" href="javascript:void(0)" style="margin-left:7px;">ลบรายการ</a>
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="hidden-480 center">รหัสสาขา</th>
                        <th class="left">ชื่อสาขา</th>
                        <th class="hidden-480 center">จังหวัด</th>
                        <th class="hidden-480 center">วันที่ปรับปรุง</th>
                ...
                <tbody>
                    <?php $i = 1; ?>
                    @foreach( $businesscenter as $key => $value )
                    <tr>
                        ...
                        <td class="center">
                            @if($value->bu_center_status=='Enable')
                                ใช้งาน
                            @else
                                ไม่ใช้งาน
                            @endif
                        ...
                        <a class="green" href="{{ URL::to('businesscenter/'.$value->bu_center_id.'/edit') }}">
                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                        </a>

                        <a href='javascript:void(0)' class="red bootbox-confirm" onclick="
                            document.getElementById('hidden_rowid').value='{{ $value->bu_center_id }}';
                            document.getElementById('hidden_rowcode').value='{{ $value->bu_center_name }}';
                            "><i class="ace-icon fa fa-trash-o bigger-120"></i></a>
                            {{ Form::open( array( 'url'=>'businesscenter/'.$value->bu_center_id, 'id'=>'form-del-'.$value->bu_center_id ) )}}
                            {{ Form::hidden( '_method','DELETE' ) }}
                            {{ Form::close() }}
                    </div>
                    <div class="hidden-md hidden-lg">
                        <div class="inline pos-rel">
                            ...
                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                ...
                                <li>
                                    <a href="{{ URL::to('businesscenter/'.$value->bu_center_id.'/edit') }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                        <span class="green">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $(".bootbox-confirm").on(ace.click_event, function () {
            ...
            bootbox.confirm({
                message: "ต้องการลบสาขา "+row_code+" ใช่หรือไม่?",
                buttons: {
                    confirm: {
                        label: "ลบ",
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $(".bootbox-confirm-delall").on(ace.click_event, function () {
            ...
            bootbox.confirm({
                message: "ต้องการลบสาขาที่เลือกทั้งหมด ใช่หรือไม่?",
                buttons: {
                    confirm: {
                        label: "ลบ",
                        className: "btn-danger btn-sm",
